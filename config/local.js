...
/*
  ADMIN_USERNAME: '@opensi',
  ADMIN_EMAIL: 'fiacre.ayedoun@mehriso.com',
  ADMIN_PASSWORD: 'opensi@dev',*/
   permissions : {
     adminUsername: '@opensi',
     adminEmail: 'fiacre.ayedoun@mehriso.com',
     adminPassword: 'opensi@dev',
     adminNom: 'KIAKIA',
     adminPrenom:'AYEDOUN fiacre'
